...
export default function TermsPage() {
  return (
    <section className="max-w-4xl mx-auto py-16 pt-32 px-4">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <ul className="list-none type-body text-base-content/80 mt-3 space-y-1.5">
            ...
            <li>Phone: <a href={`tel:${siteConfig.phone.replace(/[^+\d]/g, "")}`} className="text-primary hover:underline">{siteConfig.phone}</a></li>
            <li>Email: <a href={`mailto:${siteConfig.email}`} className="text-primary hover:underline">{siteConfig.email}</a></li>
